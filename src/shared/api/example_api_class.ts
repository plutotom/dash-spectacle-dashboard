/**
 * This is from the open api weather. I want to copy this same thing but to make it work for
 * the free national weather service api.
 * so this is just an example of how to write a class api.
 * https://www.npmjs.com/package/weathered
 *
 */
...
//             } else {
//               reject(
//                 new Error("Weather Description NOT found or in bad format.")
//               );
//             }
//           } else {
//             // handle response.cod out of ok range
...
//         new Error(
//           "No Location set! Use setCity, setCityId, setCoordinates or setZipCode before request data."
//         )
//       );
//     }
//   }
